...
const sessionSchema = new mongoose.Schema({
  ...
  sessionStartDate: { type: Number, required: [true, "請輸入場次開始日期"] },
  sessionStartTime: { type: Number, required: [true, "請輸入場次開始時間"] },
  sessionEndTime: { type: Number, required: [true, "請輸入場次結束時間"] },
